...
namespace MyCms.Areas.Admin.Controllers
{
    public class PageGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GroupeID,GroupeTitle")] PageGroup pageGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GroupeID,GroupeTitle")] PageGroup pageGroup)
        {
            if (ModelState.IsValid)
            {
